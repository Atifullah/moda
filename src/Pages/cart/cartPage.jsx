    ...
    return(
    	...
    	<div className="page section-header text-center">
			<div className="page-title">
        		<div className="wrapper"><h1 className="page-width">Shopping Cart</h1></div>
      		</div>
		</div>
                               ...
                               
                               {
                                ...
                                <tr  className="cart__row border-bottom line1 cart-flex border-top">
                                    <td className="cart__image-wrapper cart-flex-item">
                                        <a href="#"><img className="cart__image" src={image} alt=""/></a>
                                    </td>
                                    ...
                                    <td className="cart__price-wrapper cart-flex-item">
                                        <span className="money">PKR: {product_price}</span>
                                    </td>
                                    <td className="cart__update-wrapper cart-flex-item text-right">
                                        <div className="cart__qty text-center" key={id}>
                                            <div className="qtyField">
                                                <a className="qtyBtn minus" href="javascript:void(0);" onClick={()=>removeItemToCart(cartItem)}><i className="icon icon-minus"></i></a>
                                                <input className="cart__qty-input qty" type="text"  value={quantity} pattern="[0-9]*"/>
                                                <a className="qtyBtn plus" href="javascript:void(0);" onClick={()=>addItemToCart(cartItem)}><i className="icon icon-plus"></i></a>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="text-right small--hide cart-price">
                                        <div><span className="money">PKR: {()=>cartTotal(cartItem)}</span></div>
                                    </td>
                                    <td className="text-center small--hide"><a onClick={()=>clearItemFromCart(cartItem)} className="btn btn--secondary cart__remove" title="Remove tem"><i className="icon icon anm anm-times-l"></i></a></td>
                                </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 cart__footer">
                            <div class="solid-border">	
                              ...
                              <div class="row border-bottom pb-2 pt-2">
                                <span class="col-12 col-sm-6 cart__subtotal-title"><strong></strong></span>
                                <span class="col-12 col-sm-6 cart__subtotal-title cart__subtotal text-right"><span class="money">PKR: {cartTotal - cartDiscount}</span></span>
                              </div>
