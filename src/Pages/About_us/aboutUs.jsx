    ...
    return(
    	...
    	<div className="page section-header text-center">
			<div className="page-title">
        		<div className="wrapper"><h1 className="page-width">About Us</h1></div>
      		</div>
		</div>
        ...
        <div className="container">
            ...
            <div className="row">
            	<div className="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img className="blur-up lazyload" data-src="images/about1.jpg" src="images/about1.jpg" alt="About Us" /></div>
                <div className="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img className="blur-up lazyload" data-src="images/about2.jpg" src="images/about2.jpg" alt="About Us" /></div>
                <div className="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img className="blur-up lazyload" data-src="images/about3.jpg" src="images/about3.jpg" alt="About Us" /></div>
            </div>
            <div className="row">
